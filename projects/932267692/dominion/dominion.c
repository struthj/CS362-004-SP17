...
int adventurerCard(int drawntreasure,
                   struct gameState *state,
                   int currentPlayer,
                   int z,
                   int cardDrawn,
...
int seaHagCard(struct gameState *state, int currentPlayer, int i)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
      ...
      return adventurerCard(drawntreasure,state,currentPlayer,z,cardDrawn,temphand);
    ...
    case smithy:
      ...
      return smithyCard(i, currentPlayer, state, handPos);
    ...
    case salvager:
      ...
      return salvagerCard(state, choice1, currentPlayer, i);

    case sea_hag:

      return seaHagCard(state, currentPlayer, i);
